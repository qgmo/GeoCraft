...
public class PhysicsBlockLiquidWrapper extends BlockLiquidWrapper {
    protected final VanillaFlowingVanilla flowing;
    protected boolean ignoreCurrentPos = false;
    protected int expectedQuanta = 8;

    public PhysicsBlockLiquidWrapper(final @Nonnull VanillaFlowingVanilla flowing,
    ...
    public int fill(final @Nonnull FluidStack resource,final boolean doFill) {
        ...
        final Set<PlaceChoice> choices = FluidSearchUtil.findPlaceableLocations(world,blockPos,flowing.fluid,8,ignoreCurrentPos,null);
