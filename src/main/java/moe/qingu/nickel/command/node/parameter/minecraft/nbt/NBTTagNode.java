 ...
 * @author QGMoe
 */
public class NBTTagNode extends ParameterNode<NBTBase> {
    public NBTTagNode(@Nonnull final String name) {
        super(name);
    }
    ...
    @Override
    public NBTBase parse(@Nonnull final InputReader input) throws CommandException {
        input.skipWhitespaces();
        final SNBTScanner scanner = new SNBTScanner(input);
        final NBTBase value = scanner.readValue('i');
    ...
    @Nonnull
    @Override
    public Class<NBTBase> getTypeClass() {
    ...
    public String getTypeTranslationKey() {
        return "nickel.command.parameter.minecraft.nbt.tag";
    }
}
