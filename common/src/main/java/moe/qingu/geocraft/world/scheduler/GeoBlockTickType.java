...
public enum GeoBlockTickType {
    BOXED(w -> () -> new BoxedBlockTickScheduler(w)),
    PACKED(w -> () -> new PackedBlockTickScheduler(w));

    public final Function<World,Supplier<BlockTickScheduler>> provider;

    GeoBlockTickType(final @Nonnull Function<World, Supplier<BlockTickScheduler>> provider) {
